...
import SearchCertificateOfGrades from './components/SearchCertificateOfGrades';
        ...
        <div className="app-format">
          ...
          <main className='w-full'>
            <Routes>
              ...
              <Route path="/search_cor" element={<ProtectedRoute><SearchCertificateOfGrades /></ProtectedRoute>} />
